...
function salvar_customizado(url, param, salvar_ok, salvar_erro) {
    $.ajax({
        type: 'POST',           // - Method de Envio!
        processData: false,     // - Não é para o AJAX processar... enviar como receber!
        contentType: false,     // - Não informar qual o tipo do COnteúdo!
        data: param,            // - Enviar o CONTEÚDO do form.append em function get_dados_form()...
        url: url,               // - É a própria url...
        dataType: 'json',       // -  É o tipo de dados padrão - ou seja, o json...
