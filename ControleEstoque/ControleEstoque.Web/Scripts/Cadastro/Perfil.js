function set_dados_form(dados) {
    ...
    // - A VARIÁVEL VAI RECEBER O QUE ESTIVER NA LISTA PROCURANDO NELA OS INPUTS E MUDANDO A PROPRIEDADE CHECKED PARA FALSE...
...
function get_dados_form() {
    return { // Vamos pegar os Objetos Json e transformar no Model
        Id: $('#id_cadastro').val(),
        Nome: $('#txt_nome').val(),
