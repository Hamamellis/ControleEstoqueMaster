        ...
        public int Salvar()
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    if (model == null)
                    {
                        comando.CommandText = "insert into cidade (nome, id_estado, id_pais, ativo) values (@nome, @id_estado, @id_pais, @ativo); select convert(int, scope_identity())";
                    ...
                    {
                        comando.CommandText = "update cidade set nome=@nome, id_estado=@id_estado, id_pais=@id_pais, ativo=@ativo where id = @id";
